    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-5">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-2xl font-bold">892</div>
            <p className="text-xs text-muted-foreground">71.5% of enrolled</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-2xl font-bold">823</div>
