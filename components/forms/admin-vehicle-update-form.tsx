...
export function AdminVehicleUpdateForm({ vehicle, isAdmin }: { vehicle: IVehicle; isAdmin?: boolean }) {
     const defaultValues: Partial<VehicleFormValues> = {
          ...
          owner_lastName: vehicle.owner.firstName ?? "",
                              ...
                              <FormField
                                   ...
                                   render={({ field }) => (
                                        <FormItem>
                                             ...
                                             <FormControl>
                                                  <Input className="relative flex h-14 items-center rounded-2xl text-body" {...field} disabled={disabled} type="text" placeholder="Plate Number" />
                                             </FormControl>
                                             <FormMessage />
                                        </FormItem>
                                   )}
