  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-4 p-4 sm:space-y-6 sm:p-6">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className={`p-3 sm:p-4 rounded-full ${compliance.bgColor}`}>
                <ComplianceIcon
                  className={`h-8 w-8 sm:h-10 sm:w-10 ${compliance.textColor}`}
                />
              </div>
              <div className="min-w-0 flex-1">
                <h3
                  className={`text-lg sm:text-2xl font-bold ${compliance.textColor} break-words`}
                >
                ...
                <p
                  className={`text-sm sm:text-lg ${compliance.textColor.replace(
                    "800",
                    "700"
                  )} break-words`}
                >
            ...
            <div className="flex flex-row items-center justify-between sm:flex-col sm:text-right">
              ...
              {financialStatus.isOwing && (
                <div
                  className={`text-lg sm:text-2xl font-bold ${compliance.textColor}`}
                >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card
          className={
            transactionSummary.totalOwing === 0
              ? "border-green-200 bg-green-50"
              : "border-red-200 bg-red-50"
          }
        >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`font-medium text-xs sm:text-sm break-words ${
                        Number.parseFloat(transactionSummary.totalOwing) > 0
                          ? "text-red-600"
                          : "text-green-600"
                      }`}
                    >
